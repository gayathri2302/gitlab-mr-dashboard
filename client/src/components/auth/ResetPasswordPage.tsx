    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-8">
          {success ? (
            <>
              <h1 className="text-gray-100 text-lg font-semibold mb-2">Password reset!</h1>
              <p className="text-gray-400 text-sm mb-6">Your password has been updated. You can now sign in.</p>
              <button
                onClick={onDone}
                className="w-full bg-orange-600 hover:bg-orange-500 text-white font-medium text-sm rounded px-4 py-2.5 transition-colors"
              >
                Go to sign in
              </button>
            </>
            ...
            <>
              <h1 className="text-gray-100 text-lg font-semibold mb-1">Reset password</h1>
              <p className="text-gray-500 text-xs mb-6">Enter your new password below.</p>
